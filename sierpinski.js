...
const initSierpinski = function () {
    ...
    return {
        ...
        generate: function (time) {
            ...
            geometry.setAttribute('position', new THREE.BufferAttribute(new Float32Array(bufferVertices), 3));
            geometry.setAttribute('color', new THREE.BufferAttribute(new Float32Array(bufferColors), 3));
            geometry.setAttribute('cnormal', new THREE.BufferAttribute(new Float32Array(bufferNormals), 3));
